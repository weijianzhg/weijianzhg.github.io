...
<p class="card-text">{{ post.description }}</p>
                    ...
                    <p class="post-meta">
                      ...
                      <a href="{{ year | prepend: '/writing/' | prepend: site.baseurl}}">
      ...
      <p class="post-tags">
        <a href="{{ year | prepend: '/writing/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ tag | slugify | prepend: '/writing/tag/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ category | slugify | prepend: '/writing/category/' | prepend: site.baseurl}}">
